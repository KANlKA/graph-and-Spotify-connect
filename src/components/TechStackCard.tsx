...
const techIcons = [
  { name: "JavaScript", svg: <text x="8" y="20" fontSize="14" fontWeight="bold" fill="hsl(50,90%,55%)">JS</text> },
  { name: "Python", svg: (
    ...
    <div className="bento-card h-full flex flex-col">
      ...
      <div className="flex items-center justify-between gap-4 mb-5">
        {techIcons.map((tech) => (
          <div
            key={tech.name}
            className="flex items-center justify-center h-12 w-12 rounded-lg text-muted-foreground hover:text-foreground transition-colors"
          >
            {tech.name === "JavaScript" ? (
              <svg viewBox="0 0 28 28" className="h-8 w-8">
                <rect width="28" height="28" rx="3" fill="hsl(50,90%,50%)" />
                <text x="8" y="22" fontSize="16" fontWeight="bold" fill="hsl(220,20%,10%)">JS</text>
              </svg>
            ) : (
              tech.svg
            )}
