...
const techIcons = [
  {
    name: "JavaScript",
    el: (
      <div className="h-8 w-8 rounded-[3px] bg-yellow-400 flex items-center justify-center">
        <span className="text-sm font-bold text-gray-900 leading-none">JS</span>
      </div>
    ),
  },
  {
  ...
  return (
    <div className="bento-card h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center">
        <Marquee pauseOnHover className="[--duration:25s] [--gap:1.5rem]" repeat={3}>
          {techIcons.map((tech) => (
            <div
              key={tech.name}
              title={tech.name}
