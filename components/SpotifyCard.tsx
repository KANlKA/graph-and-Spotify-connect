...
const SpotifyCard = () => {
  return (
    <div className="bento-card h-full flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-sm font-semibold text-foreground">Not listening to music</p>
        <p className="text-xs text-muted-foreground uppercase tracking-wider mt-0.5">SPOTIFY</p>
      </div>
